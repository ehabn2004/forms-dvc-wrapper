  ...
  * Author: Bincsoft
  *
  * FormsGauge.java Version 1.0.2 - December 12th 2010
  */
...
public class FormsGauge extends VBean {
	...
	protected static final ID pAddGaugeData = ID.registerProperty("ADD_GAUGE_DATA"); // <Label>, <Initial value>, <Minimum value>, <Maximum value>
	...
	protected static final ID pSetIndicatorType = ID.registerProperty("SET_INDICATOR_TYPE"); // LINE (Default), NEEDLE, FILL
	protected static final ID pSetMetricLabelPosition = ID.registerProperty("SET_METRIC_LABEL_POS"); // BELOW_GAUGE, INSIDE_GAUGE, INSIDE_GAUGE_LEFT, INSIDE_GAUGE_RIGHT, NONE, WITH_BOTTOM_LABEL (Default)
	protected static final ID pSetMetricLabelNumberType = ID.registerProperty("SET_METRIC_LABEL_NUMBER_TYPE"); // NUMBER (Default), PERCENT
	protected static final ID pSetUseThresholdFillColor = ID.registerProperty("SET_USE_THRESHOLD_FILL_COLOR"); // TRUE, FALSE (Default)
	protected static final ID pSetBottomLabelPosition = ID.registerProperty("SET_BOTTOM_LABEL_POS"); // BELOW_GAUGE (Default), INSIDE_GAUGE, NONE
	protected static final ID pSetBottomLabelText = ID.registerProperty("SET_BOTTOM_LABEL_TEXT");
	protected static final ID pSetTopLabelPosition = ID.registerProperty("SET_TOP_LABEL_POS"); // ABOVE_GAUGE (Default), INSIDE_GAUGE, NONE
	...
	protected static final ID pSetTickLabelContent = ID.registerProperty("SET_TICK_LABEL_CONTENT"); // TC_NONE, TC_MIN_MAX, TC_INCREMENTS, TC_THRESHOLD, TC_METRIC
	...
	public void init(IHandler handler)
	{
		...
		super.init(handler);
		super.add(m_gauge);
		System.out.println("oracle.forms.demos.bigauge.FormsGauge version '" + sVersion
				+ "' started, oracle.dss.gauge.Gauge version '" + m_gauge.getVersion() + "'.");
	}
	...
	public boolean setProperty(ID _ID, Object _object)
	{
		   ...
		   */
			 ...
			 */       			
				...
				if (((String)_object).equalsIgnoreCase("NUMBER"))
					...
					debugMessage("SET_METRIC_LABEL_NUMBER_TYPE - Failed to set metric label number type to '" + (String)_object + "'.");
				return true;
			}
       ...
       */
        ...
        if (iContent != 0) m_gauge.getTickLabel().setContent(iContent);
        return true;
      }
       ...
       */
        ...
        debugMessage("DEBUG: " + (String)_object);
        bDebugMode = ((String)_object).equalsIgnoreCase("TRUE");
        return true;
      }             
  ...
  protected void dispatchMouseAction(String msg) {
		try {
			...
			CustomEvent ce = new CustomEvent(mHandler, eGaugeAction);
			mHandler.setProperty(pGaugeInfo, msg);
