  ...
  *
  * mViewMouseListener.java Version 1.0.2 - December 12th 2010
  */
  ...
  public void actionPerformed(ActionEvent evt) {		
    ...
    try {
          ...
          if (ch instanceof DataComponentHandle)
          {
              ...
              graphData = m_graph.getGraphModel().getDataAccess().getValue(iRowNum,iColNum,DataMap.DATA_UNFORMATTED);
              DebugMessage("mouseClicked() - Timer - Data value clicked on: "+graphData.toString());

              columnLabel=(String) m_graph.getDataAccessSliceLabel(DataDirector.COLUMN_EDGE,iColNum,MetadataMap.METADATA_LONGLABEL);
              DebugMessage("mouseClicked() - Timer - Column Name clicked on: "+columnLabel);

              rowLabel=(String) m_graph.getDataAccessSliceLabel(DataDirector.ROW_EDGE ,iRowNum,MetadataMap.METADATA_LONGLABEL);
              ...
              *********************************/
               ...
               */
              if (mfg.returnValueSelection == mfg.allData){
                  ...
                  GraphInfo = dataObject != null ? rowLabel+sDelimiter+columnLabel+sDelimiter+graphData.toString()+sDelimiter+dataObject : rowLabel+sDelimiter+columnLabel+sDelimiter+graphData.toString();
              ...
              else if (mfg.returnValueSelection == mfg.dataLabel)
              {
              ...
              else if (mfg.returnValueSelection == mfg.dataColumn)
              {
              ...
              else if (mfg.returnValueSelection == mfg.dataValue)
              {
              ...
              else if (mfg.returnValueSelection == mfg.dataPrimKey)
              {
                String dataObject=null;
